...
Cada trem executa em uma `thread` independente das outras, sem impasses, travamentos ou _deadlocks_.

### Como executar
* Basta abrir o projeto (`Trem.pro`) no Qt Creator e clicar em __build__.
